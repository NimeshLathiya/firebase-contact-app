...
const AddAndUpdateContact = ({ isOpen, onClose, isUpdate, data }) => {
  ...
  let updateContact = async (contact, id) => {
    try {
        ...
        >
          <Form className="flex flex-col gap-4">
            <div className="flex flex-col gap-1">
              ...
              <Field name="name" className="h-10 border px-4" />
            ...
            <div className="flex flex-col gap-1">
              ...
              <Field name="email" className="h-10 border px-4" />
              <div className="text-red-500 text-xs">
